const config = {
	...
	metaData: {
		title: 'huohua的个人主页🎉',
		description: '欢迎来到huohua的奇妙世界！',
		keywords: 'Bear,huohua,个人主页,个人网站',
		icon: '/favicon.ico'   //网页图标，支持外链
	},

	avatar: "/img/avatar.jpg", // 头像
	welcometitle: "Hi, I'm huohua", // 标题
	...
	// 我的标签
	tags: ['乐观开朗', '温柔体贴', '随和亲切', '三分热度', '没有脑袋', '风趣幽默', '刚正不阿', '善解人意'],
	...
	background: {
		"pc": {   //pc端
			...
			"datainfo": {
				"title": "高质量动态背景",
				"preview": "https://media.huohua-personal.top/bg-highres.mp4",
				"url": "https://media.huohua-personal.top/bg-highres.mp4",     //当然，也可填写网络地址或壁纸api，如随机PC壁纸api："url":"https://t.mwm.moe/pc"
			},
		},
		"mobile": {   //移动端
			"type": "video",
			"datainfo": {
				"title": "高质量动态背景",
				"preview": "https://media.huohua-personal.top/bg-highres.mp4",
				"url": "https://media.huohua-personal.top/bg-highres.mp4"  //同理，随机移动端壁纸："url":"https://t.mwm.moe/mp"
			}
		}
	...
	musicPlayer: {
		localTracks: [
			{ title: "About Love_H", author: "DJ_Komie", url: "/music/bgm.mp3", pic: "/img/avatar.jpg", lrc: "" }
		],
	...
	projectcards: [
		...
		{ go: "📝 前往", img: "https://unsplash.com/photos/xHMmSxmKfIU/download?force=true", title: "发表作品", subtitle: "2,000 miles of wonder", text: "If you see this line, I've managed to get your attention.", url: "https://xhslink.com/m/8lJWZv2myFl", show: false },
